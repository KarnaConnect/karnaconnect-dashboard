    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
        ...
        .logo-sub {
          font-size:0.62rem; color:#2a3f6b; text-transform:uppercase;
          letter-spacing:2px; margin-top:5px; padding-left:43px;
        }
        ...
        .live-clock {
          ...
          font-size:0.68rem; color:#2a4070;
        ...
        .nav-group-label {
          ...
          color:#1e3060; font-weight:700; padding:0 10px;
          margin:12px 0 6px;
        }
        .nav-item {
          display:flex; align-items:center; gap:9px; padding:9px 12px;
          border-radius:9px; margin-bottom:2px;
          color:#3d5a8a; font-size:0.83rem; font-weight:500;
          cursor:pointer; transition:all 0.18s; position:relative;
          white-space:nowrap; overflow:hidden;
        }
        .nav-item.active {
          background:linear-gradient(135deg,rgba(37,99,235,0.18),rgba(6,182,212,0.08));
          color:#e8f0ff; border:1px solid rgba(37,99,235,0.25);
        }
        .nav-item.active::before {
          content:''; position:absolute; left:0; top:20%; bottom:20%;
          width:3px; background:linear-gradient(180deg,#2563eb,#06b6d4);
        ...
        .sidebar-foot {
          ...
          font-size:0.68rem; color:#1e3060; line-height:1.8;
        }
        ...
        .page-title {
          font-size:1.6rem; font-weight:800; color:#08112b;
        ...
        .stat-card {
          ...
          box-shadow:0 1px 4px rgba(8,17,43,0.05);
        ...
        .stat-value {
          font-size:1.9rem; font-weight:800; color:#08112b;
        ...
        .table-hdr-title {
          font-size:0.95rem; font-weight:700; color:#08112b;
        ...
        .desktop-table th {
          padding:10px 18px; text-align:left; font-size:0.67rem;
          text-transform:uppercase; letter-spacing:1.2px;
          color:#94a3b8; font-weight:700; border-bottom:1px solid #f1f5f9;
          white-space:nowrap;
        }
        .desktop-table td {
          padding:14px 18px; font-size:0.845rem; color:#334155;
          border-bottom:1px solid #f8fafc; vertical-align:middle;
          max-width:0; /* forces overflow:hidden to work */
        }
        ...
        .call-card {
          border-bottom:1px solid #f1f5f9; padding:16px 20px; cursor:pointer;
        ...
        .dur-chip {
          ...
          font-size:0.77rem; color:#475569; font-weight:600;
          white-space:nowrap;
        }
        .outcome-badge {
        ...
        .summary-expand td {
          background:#f5f9ff; padding:14px 22px 14px 36px;
          font-size:0.84rem; color:#475569; line-height:1.75;
        ...
        .summary-expand-label {
          ...
          color:#2563eb; font-weight:700; margin-bottom:5px;
        }
        ...
        .overlay {
          ...
          background:rgba(8,17,43,0.5); z-index:150;
